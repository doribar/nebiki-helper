...
const allowedLocalStoragePrimitiveSignatures = new Set([
  ...
  // Reviewed migration boundary: used only after exact IndexedDB read-back
  // verification to retain the protected current-date operational subset.
  "src/domain/historicalArchive.ts|storage.setItem|key",
