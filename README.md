...
- アプリ版: `2026.7.21-1`。`dataSchemaVersion` は2のままです。簡易モードの色分けと視認性を維持しながら、共通ヘッダー、基準・注意表示、5段階ボタン、1周目・2周目の指示と操作ボタン、最終値引一覧を390×844pxでスクロールせず使える密度へ圧縮しました。値引ロジック、画面遷移、保存、詳細モード、Supabase SQLは変更していません。
